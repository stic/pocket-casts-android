...
class PodcastManagerTest {
    ...
    fun setup() {
        ...
        val settings = mock<Settings> {
            on { podcastGroupingDefault } doReturn UserSetting.MockUserSetting(PodcastGrouping.None, mock())
            on { showArchivedDefault } doReturn UserSetting.MockUserSetting(false, mock())
        }
